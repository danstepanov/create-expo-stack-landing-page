...
export default function Supabase() {
  return (
    <div className="group overflow-hidden cursor-wait border-dashed hover:rounded-xl duration-300 shadow-[inset_0_0_3rem_#3FCF8E44] border-[#3FCF8E]/70 bg-[#3FCF8E]/10 backdrop-blur-sm border text-[#7FFFBE]/80 p-4 sm:pr-20 flex-grow rounded-3xl flex flex-col items-start">
      <Image
