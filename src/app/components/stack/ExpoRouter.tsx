...
export default function ExpoRouter() {
  return (
    <a
      ...
      className="group overflow-hidden shadow-[inset_0_0_3rem_#fff4] hover:shadow-[inset_0_0_8rem_#fff4,0_0_2rem_#fff4] border-white/40 hover:border-white/80 bg-white/10 backdrop-blur-sm border text-white p-4 sm:pr-8 w-full md:w-auto flex-grow rounded-3xl flex flex-col items-start duration-500"
    >
      <Image
