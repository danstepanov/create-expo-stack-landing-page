...
export default function Tamagui() {
  return (
    <a
      ...
      className="group overflow-hidden shadow-[inset_0_0_3rem_#fff4] border-white/70 bg-gradient-to-br from-yellow-400/10 via-cyan-400/10 to-pink-400/10 backdrop-blur-sm border text-white/80 p-4 sm:pr-20 flex-grow rounded-3xl flex flex-col items-start duration-500 border hover:rounded-xl"
    >
      {/* <Image
